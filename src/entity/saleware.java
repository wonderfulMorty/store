...
public class saleware {
	...
	public String toString() {
		return "saleware [wareid=" + wareid + ", warename=" + warename + ", size=" + size + ", color=" + color
				+ ", warenum=" + warenum + ", realprize=" + realprize + ", sumprize=" + sumprize + ", saletime="
				+ saletime + ", sname=" + sname + ", staff=" + staff + "]";
	}
	
	public saleware(String wareid, String warename, String size, String color, String warenum, String realprize,
			String sumprize, String saletime, String sname,entity.staff staff) {
		super();
		this.wareid = wareid;
		this.warename = warename;
		this.size = size;
