...
public class wareaddJFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					wareaddJFrame frame = new wareaddJFrame(tm,lablecount);
	 ...
	 * @param lablecount2 
	 */
	public wareaddJFrame(DefaultTableModel tm, JLabel lablecount) {
//		this.lablecount=lablecount;
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {//疑似有异常的对象
					ss.addware(ware);
			    	tm.addRow(new Object[] {wareid, warename, waredd,color,size,inprize,outprize,num});//添加界面
